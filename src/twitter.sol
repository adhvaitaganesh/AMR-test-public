...
contract ChainlinkTwitter is ChainlinkClient {
    ...
    //Now we add tweets functionality
    //basiclly what we need to implemrnt is the possibility of getting teet analytics and sending tweets via the smart contract for testing and future
